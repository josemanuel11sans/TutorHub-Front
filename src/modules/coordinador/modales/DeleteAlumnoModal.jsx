...
export function DeleteAlumnoModal({ alumno, onClose, onConfirm }) {
  return (
    <div 
      ...
      >
        ...
        <div className="p-6">
          <p className="text-sm text-gray-700 mb-4">
            ¿Estás seguro de que deseas eliminar al alumno <span className="font-semibold">{alumno.nombre} {alumno.apellido}</span>?
          </p>
          <div className="bg-red-50 border border-red-100 rounded-lg p-3 flex gap-2 mb-6">
            <AlertTriangle className="h-4 w-4 text-red-600 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-red-700">
              Esta acción eliminará lógicamente al alumno.
            </p>
          </div>
