...
export function EditTutorModal({ tutor, onClose, onUpdate }) {
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-100 relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Editar Tutor</h2>
              <p className="text-gray-500 text-xs">Actualiza la información del tutor</p>
            </div>
          </div>
          <button
            onClick={onClose}
