...
const ESPACIOS_MOCK = [
  {
    id_espacio: 1,
    nombre: "Roberto Martinez Silva",
    correo: "roberto.m@escuela.edu",
    telefono: "123456789",
    estado: true,
  },
  {
    id_espacio: 2,
    nombre: "Carmen Lucia Torres",
    correo: "carmen.l@escuela.edu",
    telefono: "123456789",
    estado: true,
  },
  {
    id_espacio: 3,
    nombre: "Cesar Augusto Lopez",
    correo: "cesar.a@escuela.edu",
    telefono: "32452352",
    estado: true,
  }
]
...
export default function EspaciosTutorPage() {
  ...
  const filteredEspacios = espacios.filter(espacio =>
    ...
    espacio.correo?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    espacio.telefono?.toLowerCase().includes(searchTerm.toLowerCase())
  )
