...
const Badge = ({ children, variant = "default" }) => {
    const variants = {
        coordinador: "bg-blue-600 text-white",
        tutor: "bg-gray-300 text-gray-800",
        alumno: "bg-white text-gray-700 border border-gray-300",
...
const ESPACIOS_MOCK = [
    {
        id_espacio: 1,
        nombre: "Carlos Rodriguez García",
        descripcion: "coordinador@escuela.edu",
        edificio: "Coordinador",
        estado: true,
    },
    {
        id_espacio: 2,
        nombre: "María López Sánchez",
        descripcion: "maria.tutor@escuela.edu",
        edificio: "Tutor",
        estado: true,
    },
    {
        ...
        descripcion: "juan.tutor@escuela.edu",
        edificio: "Tutor",
        estado: true,
    },
    {
        ...
        descripcion: "ana.alumno@escuela.edu",
        edificio: "Alumno",
        estado: true,
    },
    {
        ...
        descripcion: "pedro.alumno@escuela.edu",
        edificio: "Alumno",
        estado: false,
    }
]
                                    ...
                                    filteredEspacios.map((espacio) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <Badge
                                                    variant={
                                                        espacio.edificio.toLowerCase() === "coordinador"
                                                            ? "coordinador"
                                                            : espacio.edificio.toLowerCase() === "tutor"
                                                                ? "tutor"
                                                                : "alumno"
                                                    }
                                                >
