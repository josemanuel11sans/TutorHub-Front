      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-100 relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Eliminar Material</h2>
        ...
        <div className="p-6">
          <p className="text-sm text-gray-700 mb-4">
            ...
            <span className="font-semibold">{material.nombre}</span>?
          </p>

          <div className="bg-red-50 border border-red-100 rounded-lg p-3 flex gap-2 mb-6">
            <AlertTriangle className="h-4 w-4 text-red-600 flex-shrink-0 mt-0.5" />
            <p className="text-xs text-red-700">
              Esto desactivará lógicamente el material. No se eliminará el archivo físico.
            </p>
          </div>
