...
export function DeleteAsesoriaModal({ asesoria, onClose, onConfirm }) {
  return (
    <div
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-100 relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Eliminar Asesoría</h2>
        ...
        <div className="p-6">
          <p className="text-sm text-gray-700 mb-4 leading-relaxed">
            ¿Deseas eliminar la asesoría del alumno{" "}
          ...
          <div className="bg-red-50 border border-red-100 rounded-lg p-3 flex gap-2 mb-6">
            ...
            <p className="text-xs text-red-700">
              Esta acción eliminará lógicamente la asesoría del sistema.
            </p>
          </div>
